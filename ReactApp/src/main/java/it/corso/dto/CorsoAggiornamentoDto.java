...
/**
 * DTO (Data Transfer Object) utilizzato per l'aggiornamento dei dati di un corso.
 * Contiene le informazioni necessarie per aggiornare un corso esistente.
 */
public class CorsoAggiornamentoDto {
    
    /**
     * L'ID del corso da aggiornare.
     * Deve essere un valore positivo.
     */
    @Min(value = 1, message = "L'id deve essere un valore positivo")
    private int id;
